...
test_that("gt_pct_bar SVG is created and has specific palette", {
  ...
  ex_df <- dplyr::tibble(
    x = c("Example 1","Example 1", "Example 2","Example 2",
  ...
  expect_equal(bar_vals, c(0, 119.06, 0, 124.02, 0, 85.04, 0, 85.04))
  expect_equal(
    bar_colors,
    c("FF4343;", "BFBFBF;", "FF4343;", "BFBFBF;",
      "FF4343;", "BFBFBF;", "FF4343;", "BFBFBF;")
  )
